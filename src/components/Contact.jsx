...
export default function Contact() {
  ...
  const setField = (field) => (e) => {
    ...
    // Re-validate live only once a field has been marked invalid.
      ...
      <div className="container">
        <header className="section-header reveal">
          ...
          <p className="section-subtitle">
            Book a car wash, ask a question, or share feedback. We'd love to hear from you.
          </p>
        </header>
        ...
        <div className="contact__inner">
          ...
          <div className="contact__form-wrap reveal reveal-d1">
            <form className="contact-form" onSubmit={onSubmit} noValidate aria-label="Contact and booking form">
              ...
              <div className="form-group">
                ...
                <textarea
                  ...
                  placeholder="Tell us your car model, preferred date/time, and any special requests…"
                  aria-required="true"
